...
\achievement{
    ...
    Computer Vision:
    \begin{itemize}
        \item Building a YOLO technology model to detect logos in TV real-time airings.
        \item Using an OCR Conv Net model to detect text in banners
        \item Using YOLO technology to detect objects in banners and TV airings
    \end{itemize}
}
...
\experience{ITBA (Buenos Aires Institute of Technology)}{Professor}{Sep 2017}{Present}{ \newline
    ...
    Professor at Deep learning's Lab degree. Contents of lessons: \newline
    \achievement{
        GAI (Generative AI, transformers, GPT, LLaMa, LangChain, Promp Engineering)
    }
    \achievement{
        MLOPs (Docker, Kubernetes, CI/CD, Dagster, MLFLOW, Airbyte)
    }
    \achievement{
...
\experience{Croma Inc}{Parter and ML Engineer}{Sep 2017}{Sep
    2020}{\newline

    \achievement{

        Built a Computer Vision detection system used to find free
        parking spots (Conv Nets technology)

    }

    \achievement{

        Designed and built a GNI (Google News Innovation) project on NLP: Named Entity
    ...
    \achievement{
        ...
        Built Croma AI platform for news analysis - Named Entity
        Recognition,
...
\experience{Globant}{Android developer and Machine Learning Engineer at Iamat}{Mar 2013}{Sep 2017}{\newline
    \achievement{
        ...
        Built a Memes Recommender System.

        Built OCR and Object detection computer vision systems based on
        conv nets.
