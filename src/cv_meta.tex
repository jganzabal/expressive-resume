...
\achievement{
    ...
    Computer Vision:
    - Building a YOLO technology model to detect
    logos in TV real-time airings.
    - Using an OCR conv net model to detect text in banners
    - Using YOLO technology to detect objects in banners and TV airings
