...
% \objective{}
Experienced Machine Learning Engineer with a demonstrated history in
...
design using {\it Dagster} as an orchestrator, {\it Airbyte} as the ELT
...
\achievement{
    ...
    and Object detection in TV streams and Youtuve Channels.
...
\experience{ITBA (Buenos Aires Institute of Technology)}{Professor}{Sep 2017}{Present}{ \newline
    ...
    \achievement{
        Computer Vision Lab (ConvNets applied to Images, Video and Audio)
    }
    \achievement{
        Natural Language Processing Lab (RNN applied to NLP)
    }
    \achievement{
